...
const starSign = queries.get("starSigns");

const dates = {
  Aries: "Aries (March 21st - April 19th)",
  Taurus: "Taurus (April 20th - May 20th)",
  Gemini: "Gemini (May 21st - June 20th)",
  Cancer: "Cancer (June 21st - July 22nd)",
  Leo: "Leo (July 23rd - August 22nd)",
  Virgo: "Virgo (August 23rd - September 22nd)",
  Libra: "Libra (September 23rd - October 22nd)",
  Scorpio: "Scorpio (October 23rd - November 21st)",
  Sagittarius: "Sagittarius (November 22nd - December 21st)",
  Capricorn: "Capricorn (December 22nd - January 19th)",
  Aquarius: "Aquarius (January 20th - February 18th)",
  Pisces: "Pisces (February 19th - March 20th)",
};
...
date.innerText = dates[starSign];
articles.appendChild(date);

const horoscope = document.createElement("p");
horoscope.innerText = horoscopes[starSign];
articles.appendChild(horoscope);
